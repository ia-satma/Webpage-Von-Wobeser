...
.page.careers .careers--wrap.vw-careers-layout{display:grid!important;box-sizing:border-box;width:100%;max-width:100%;min-width:0;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:clamp(34px,5vw,72px);align-items:start}
...
@media(max-width:680px){.page.careers{padding:5.25rem 0 48px!important}.page.careers .careers--wrap.vw-careers-layout{margin-left:0!important;margin-right:0!important;min-width:0}.page.careers .vw-careers-header,.page.careers .vw-careers-copy,.page.careers .vw-careers-copy .careers__content,.page.careers .vw-careers-form{min-width:0;max-width:100%}.page.careers .vw-careers-copy .careers__content p,.page.careers .vw-careers-header__description{overflow-wrap:anywhere}.page.careers .vw-careers-form{grid-template-columns:1fr;gap:20px;width:100%!important;margin-top:2.5rem!important;padding:22px 18px!important}.page.careers .vw-careers-form--culture{margin-top:1.5rem!important}.page.careers .vw-careers-form .vw-careers-form__upload,.page.careers .vw-careers-form .vw-careers-form__filename,.page.careers .vw-careers-form .vw-careers-form__privacy,.page.careers .vw-careers-form .vw-careers-form__submit,.page.careers .vw-careers-form .vw-careers-form__help,.page.careers .vw-careers-form .vw-careers-form__loader,.page.careers .vw-careers-form [data-vw-feedback]{grid-column:auto}.page.careers .vw-careers-form .vw-careers-form__privacy{align-items:flex-start;font-size:15px}.page.careers .vw-careers-form .vw-careers-form__filename{margin-top:-8px!important}}
