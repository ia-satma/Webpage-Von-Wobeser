...
const DEFAULTS: Array<{ key: string; value: string; valueEs?: string; type: string; category: string; description: string }> = [
  ...
  { key: "page_careers_title", value: "Your career at Von Wobeser y Sierra", valueEs: "Tú carrera en Von Wobeser y Sierra", type: "text", category: "pages", description: "Carrera — título principal" },
