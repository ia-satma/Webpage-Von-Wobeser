...
const BASELINE_ROUTE_COUNT = 216;
const BASELINE_ROUTE_SHA256 = "fbcdabbdaee7a54ce89b09c16f719243a255d350d6295d11bb8cfdf9944733f0";
...
test("la modularización conserva exactamente los 216 métodos, rutas y su orden", async () => {
