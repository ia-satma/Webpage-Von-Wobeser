...
const jaCommon = {
  ...
  common: { loading: "読み込み中...", error: "エラーが発生しました", noResults: "結果が見つかりません", search: "検索", filter: "フィルター", sort: "並べ替え", all: "すべて", close: "閉じる", open: "開く", menu: "メニュー", language: "言語", selectLanguage: "言語を選択", mainNav: "メインナビゲーション", mobileNav: "モバイルナビゲーション", openSearch: "検索を開く", closeSearch: "検索を閉じる", openMenu: "メニューを開く", closeMenu: "メニューを閉じる", searchPlaceholder: "検索...", expandSubmenu: "サブメニューを展開", collapseSubmenu: "サブメニューを折りたたむ", viewAll: "すべて表示", searchResults: "検索結果" }
};
