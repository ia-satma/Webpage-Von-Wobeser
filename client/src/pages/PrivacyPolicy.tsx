...
Sito web: www.vonwobeser.com`
  ...
  return (
    <div data-testid="page-privacy-policy" className="vw-old">
      ...
      <Section tone="white" size="compact" fade={false}>
        <p className="vw-label text-[11px] text-vw-gray" data-testid="text-privacy-updated">
          {t.lastUpdated}
        </p>
      </Section>
      ...
      <Section tone="white" fade={false} innerClassName="max-w-4xl">
        ...
        <div className="mt-16 border border-vw-graylight bg-[#f4f4f4] p-8 text-center">
          <Shield className="mx-auto mb-4 h-9 w-9 text-vw-red" aria-hidden="true" />
