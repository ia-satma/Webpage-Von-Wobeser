...
export const SECURITY_INFRASTRUCTURE: SystemFeature[] = [
  {
    ...
    technicalName: 'PostgreSQLRateLimit',
    technicalDetail: 'Rate limiting compartido en PostgreSQL por hash de IP e identificador, con ventana de 15 minutos, máximo 5 intentos y bloqueo de 30 minutos. Funciona entre todas las instancias autoscale sin guardar el correo o la IP en texto claro.',
  ...
  },
  {
    ...
    technicalDetail: 'Contraseñas nuevas con Argon2id (19 MiB, 2 iteraciones), migración progresiva desde bcrypt, MFA TOTP obligatorio para administradores y sesiones en cookie HttpOnly/Secure/SameSite Strict. PostgreSQL guarda solo hashes de tokens, con 30 minutos de inactividad, máximo absoluto de 8 horas y CSRF.',
    userBenefit: 'Protección reforzada del panel sin exponer credenciales al JavaScript del navegador.',
    status: 'production',
    keyCapabilities: [
  ...
  },
  {
    ...
    technicalDetail: 'Cuarentena, nombres aleatorios de 128 bits, verificación de firma real y análisis ClamAV. Los CV quedan fuera de /uploads y se descargan únicamente mediante un endpoint autenticado con permiso de registros.',
    ...
    keyCapabilities: [
      ...
      'SVG, HTML y ejecutables rechazados',
      'Nombrado criptográfico único',
      'Firma real y ClamAV',
      'CV privados fuera del directorio público',
    ],
    technicalSpecs: {
      maxFileSize: '10MB',
  ...
  },
  {
    ...
    technicalDetail: 'WebSocket autenticado mediante la sesión HttpOnly, con validación estricta de Origin, MFA heredado de la sesión, máximo de tres conexiones por usuario y heartbeat cada 30 segundos.',
