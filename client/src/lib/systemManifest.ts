...
export const SECURITY_INFRASTRUCTURE: SystemFeature[] = [
  ...
  },
  {
    ...
    technicalDetail: 'Acceso con usuario y contraseña, Argon2id (19 MiB, 2 iteraciones), migración progresiva desde bcrypt y sesiones en cookie HttpOnly/Secure/SameSite Strict. PostgreSQL guarda solo hashes de tokens, con 30 minutos de inactividad, máximo absoluto de 8 horas y CSRF.',
