export const teamFormTranslations = {
  en: {
    ...
    partnerSinceYear: "Partner since",
    partnerSinceYearDesc: "Year this person became a Partner. It only appears in the Partners listing.",
    showPartnerSince: "Show partner tenure in the Partners listing",
    showPartnerSinceDesc: "Turn this off to hide only the year; the profile remains published.",
    order: "Display Order",
  ...
  es: {
    ...
    partnerSinceYearDesc: "Año en que se convirtió en Socio. Sólo aparece en el listado de Socios.",
    showPartnerSince: "Mostrar antigüedad en el listado de Socios",
    showPartnerSinceDesc: "Al apagarlo se oculta sólo el año; el perfil seguirá publicado.",
