...
const content: Record<LanguageCode, VisionContent> = {
  ...
  zh: {
    title: "未来、协作与卓越的愿景",
    text: "Von Wobeser y Sierra 已完成向波兰科区充满活力的 Campos Elíseos 地区新办公室的搬迁。这次搬迁标志着公司进入成长、发展和巩固的新阶段，是对公司未来的关键投资。新设施旨在最大限度地促进各领域的协作，造福客户，确保持续提供高质量的综合服务，重申公司"客户需要我们的地方，我们就在那里"的承诺和理念。",
