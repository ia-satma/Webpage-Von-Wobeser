#!/usr/bin/env node
// Aplica scripts/permissions-and-login-log.sql a la base Neon.
// Idempotente (ADD COLUMN IF NOT EXISTS / CREATE TABLE IF NOT EXISTS / CREATE INDEX IF NOT EXISTS)
// y no destructivo.
//   node scripts/apply-permissions-and-login-log.mjs
...
const sqlText = fs.readFileSync(path.join(__dirname, "permissions-and-login-log.sql"), "utf8");
